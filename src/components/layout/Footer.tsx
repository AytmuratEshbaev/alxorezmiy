  ...
  return (
    <footer className="footer">
      <div className="container">
        <div className="footer-grid">
          <div className="footer-about">
            ...
            <div className="footer-social">
              {s?.telegram && (
                <a href={s.telegram} target="_blank" rel="noopener" aria-label="Telegram">
          ...
          <div>
            ...
            <ul className="footer-links">
              ...
              <li>
                <Link href="/directions">{t('nav.directions')}</Link>
              </li>
              <li>
                <Link href="/teachers">{t('nav.teachers')}</Link>
              </li>
              <li>
                <Link href="/achievements">{t('nav.achievements')}</Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="footer-contact">
              {s?.address && (
                <li>
                  <span>{SocialIcons.pin}</span> <span>{s.address}</span>
                </li>
              )}
              {s?.phone && (
                <li>
              ...
              {s?.email && (
                <li>
                  <span>{SocialIcons.mail}</span> <a href={`mailto:${s.email}`}>{s.email}</a>
                </li>
              )}
              {s?.hours && (
                <li>
                  <span>{SocialIcons.clock}</span> <span>{s.hours}</span>
                </li>
              )}
            </ul>
          </div>
        ...
        {fullName && (
          <div
            className="footer-official-name"
            style={{
        ...
        <div className="footer-bottom">
          ...
          <span>Nukus, Qoraqalpog&rsquo;iston</span>
        </div>
      </div>
    </footer>
  );
